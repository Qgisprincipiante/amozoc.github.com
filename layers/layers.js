...
var lyr_REDVIAL_2 = new ol.layer.Vector({
                ...
                interactive: true,
    title: 'RED VIAL<br />\
    <img src="styles/legend/REDVIAL_2_0.png" /> Fed.<br />\
    <img src="styles/legend/REDVIAL_2_1.png" /> N/A<br />\
    <img src="styles/legend/REDVIAL_2_2.png" /> N/D<br />\
    <img src="styles/legend/REDVIAL_2_3.png" /> Pue.<br />'
        });
...
lyr_MUNICIPIODEAMOZOC_1.set('fieldAliases', {'CVEGEO': 'CVEGEO', 'CVE_ENT': 'CVE_ENT', 'CVE_MUN': 'CVE_MUN', 'NOMGEO': 'NOMGEO', });
...
lyr_MUNICIPIODEAMOZOC_1.set('fieldImages', {'CVEGEO': 'TextEdit', 'CVE_ENT': 'TextEdit', 'CVE_MUN': 'TextEdit', 'NOMGEO': 'TextEdit', });
...
lyr_MUNICIPIODEAMOZOC_1.set('fieldLabels', {'CVEGEO': 'no label', 'CVE_ENT': 'no label', 'CVE_MUN': 'no label', 'NOMGEO': 'no label', });
